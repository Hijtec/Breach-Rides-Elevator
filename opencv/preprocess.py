...
def adjust_brightness_dynamic(image, brightness=0.0, contrast=0.0):
    ...
    out = imutils.adjust_brightness_contrast(
...
def boxdimension_filter(
    image, boxes, size_lim=None, width_lim=None, height_lim=None, ratio_wh_lim=None
):
    """Based on criteria filters the given bounding boxes and draws them upon image."""
    boxes_filtered = []
    for box in boxes:
        x_1, y_1 = box[0]
        x_2, y_2 = box[1]
